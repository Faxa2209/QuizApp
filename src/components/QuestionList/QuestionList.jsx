...
const QuestionList = ({ gameOptions, handleGameStart, handleNoQuestionsError }) => {
    ...
    const checkAnswers = () => {
        if (allQuestionsAnswered) {
            ...
            setQuestionsArray((prevQuestionsArray) => prevQuestionsArray.map((question) => ({ ...question, showAnswer: true })));
        }
    };
    ...
    return (
        <section className="questionList-container">
            ...
            <div className="bottom-container">
                {isGameOver && <h3 className="correct-answers-text">You scored {correctAnswersCount}/5 correct answers</h3>}
